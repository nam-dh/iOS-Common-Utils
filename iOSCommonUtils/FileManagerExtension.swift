...
public extension FileManager {
    ...
    static func isExistedInDocumentDirectory(_ fileName: String) -> Bool {
        let filePath = pathFileInDocumentDirectory(fileName)
        return FileManager.default.fileExists(atPath: filePath)
    }

    static func pathFileInDocumentDirectory(_ fileName: String) -> String {
        return urlFileInDocumentDirectory(fileName).path
    }

    static func urlFileInDocumentDirectory(_ fileName: String) -> URL {
        return self.documentsDirectoryURL.appendingPathComponent(fileName)
    }

    static func removeFileInDocumentDirectory(fileName: String) {
    ...
    static func renameItemAtURL(_ path: String, newName: String) throws {
    ...
    static func intSizeForLocalFile(filePath: String) -> UInt64 {
        do {
    ...
    static func stringSizeForLocalFile(filePath: String) -> String {
